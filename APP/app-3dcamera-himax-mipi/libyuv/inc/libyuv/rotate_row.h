...
#define HAS_TRANSPOSEWX8_16_NEON
#endif
...
void TransposeWx8_NEON(const uint8_t* src,
                       ...
                       int dst_stride,
                       int width);
void TransposeWx8_16_C(const uint8_t* src,
                       int src_stride,
                       uint8_t* dst,
                       int dst_stride,
                       int width);
void TransposeWxH_16_C(const uint8_t* src,
                       int src_stride,
                       uint8_t* dst,
                       int dst_stride,
                       int width,
                       int height);
void TransposeWx8_16_NEON(const uint8_t* src,
                          int src_stride,
                          uint8_t* dst,
                          int dst_stride,
                          int width);
